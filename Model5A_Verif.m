...
function xprime = Model5A_Verif(p,equi)
    ...
    xprime5 = - qH*rH*H*Porg/(epsiH*kOrgH) - qC*rC*C*Porg/(epsiC*kOrgC) + qV*thetaH*Vh + (qH - qV*betaH)*phiH*H*Vh + qH*sigmaH*H + qC*sigmaC*C + pEx*Z*(qH*gammaH*H + qC*gammaC*C);
