...
function xprime = Model4A_Verif(p,equi)
...
xprime1 = rH*H*Norg/kOrg - phiVH*H*Vh - gammaH*H*Z - lambdaH*H - sigmaH*H;
...
xprime5 = -bH*rH*H*Norg/(kOrg*epsiH) + bV*thetaH*Vh + (bH - bV*betaH)*phiVH*H*Vh + bH*sigmaH*H + bC*sigmaC*C + pEx*Z*(bH*gammaH*H + bC*gammaC*C);
xprime6 = betaH*phiVH*H*Vh - thetaH*Vh; 

xprime = [xprime1, xprime2, xprime3, xprime4, xprime5,xprime6];