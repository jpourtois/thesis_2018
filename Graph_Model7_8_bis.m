% Make alternate graph comparing Model 7 and 8
...
set(gca,'xscale','log')
set(gca,'yscale','log')
xlabel("without viruses",'FontSize', 14)
ylabel("with viruses",'FontSize', 14)
xlim([10^6 10^11])
ylim([10^6 10^11])
xticks([10^6 10^8 10^10])
yticks([10^6 10^8 10^10])
title("Heterotrophic bacteria (L^{-1})",'FontSize', 14)
...
title("Cyanobacteria (L^{-1})",'FontSize', 14)
...
title("Zooplankton (L^{-1})",'FontSize', 14)
...
title("Inorganic nitrogen (\muM)",'FontSize', 14)
...
title("Organic nitrogen (\muM)",'FontSize', 14)
...
xticks([10^-5 10^-3 10^-1 10^1 10^3])
yticks([10^-5 10^-3 10^-1 10^1 10^3])
title("Primary Productivity (\muM N d^{-1})",'FontSize', 14)
ax = gca;
...
xticks([10^-4 10^-2 1 10^2])
yticks([10^-4 10^-2 1 10^2])
title("Inorganic phosphorus (\muM)",'FontSize', 14)
...
title("Organic phosphorus (\muM)",'FontSize', 14)
...
xticks([10^-7 10^-5 10^-3 10^-1 10^1])
yticks([10^-7 10^-5 10^-3 10^-1 10^1])
title("Primary Productivity (\muM P d^{-1})",'FontSize', 14)
%ax = gca;
%ax.TitleFontSizeMultiplier = 1;
...
xticks([10^-5 10^-3 10^-1 10^1 10^3])
yticks([10^-5 10^-3 10^-1 10^1 10^3])
title("DON recycling (\muM d^{-1})",'FontSize', 14)
...
title("Nutrient Export (\muM N d^{-1}) ",'FontSize', 14)
...
title("Carbon sink (\muM C d^{-1})",'FontSize', 14)
...
xticks([10^-5 10^-3 10^-1 10^1 10^3])
yticks([10^-5 10^-3 10^-1 10^1 10^3])
title("DOP recycling (\muM d^{-1})",'FontSize', 14)
...
title("Nutrient Export (\muM P d^{-1}) ",'FontSize', 14)
