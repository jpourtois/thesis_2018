...
function xprime = Model3B_Verif(p,equi)
    ...
    xprime1 = rH*H*Pin/(Pin + kInH) - gammaH*H*Z - lambdaH*H - sigmaH*H;
    ...
    xprime4 = qH*sigmaH*H + pEx*qH*gammaH*H*Z - psiH*H*Porg;
        
    xprime = [xprime1, xprime2, xprime3, xprime4];